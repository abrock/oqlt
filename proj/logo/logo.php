...
class oqltLogo {
 ...
 /**
  * Berechnet aus den drei Seitenl‰ngen eines Dreiecks den Winkel
  * der der dritten Seite gegen¸berliegenden Seite.
  *
  * @param double Seite a
  * @param double Seite b
  * @param double Seite c
  * @return double Gamma, der Winkel gegen¸ber von c. c≤ = a≤ + b≤ + 2ab*cos(gamma)
  */
 ...
 /**
  * Berechnet die Halbwinkel der L¸cken im ‰uﬂeren Kreis bei geradlinigen L¸cken.
  *
  * @param double Strecke, die die Spitze des Pentagrammes ¸ber den Kreis hinaussteht
  * @param double Radius des Kreises
  * @param double ÷ffnungswinkel des Pentagrammes in Grad
  * @return double Haldwinkel der L¸cke in Grad
  */
